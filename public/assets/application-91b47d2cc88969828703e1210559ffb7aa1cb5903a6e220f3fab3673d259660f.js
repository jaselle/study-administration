...
(function() {
  ...
  set_stars = function(form_id, stars) {
    var i;
    i = 1;
    while (i <= 5) {
      if (i <= stars) {
...
(function() {
  $(function() {
    $('body').on('click', 'tr.sorts th a', function(e) {
      e.preventDefault();
      return $.ajax({
        type: 'GET',
        url: this.href,
    ...
    return $('#search input').keyup(function() {
      return $.get($('#users_search').attr('action'), $('#users_search').serialize(), null, 'script');
    });
  });
